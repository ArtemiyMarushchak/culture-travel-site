...
export const STRINGS = {
  ru: {
    ...
    'footer.updated': 'Сайт обновлён —',
    'footer.home': 'Главная',
    'footer.nav': 'Навигация',
    'footer.docs': 'Документы для контроля',
    'footer.privacy': 'Политика конфиденциальности',
    'footer.registry': 'В реестре тур-агентств',
    'footer.company': 'Данные компании',
    'footer.copyright': 'Авторское право',
    'footer.copyban': 'Копирование материалов запрещено',
  ...
  en: {
    ...
    'hero.title': 'Site under development',
    ...
    'footer.registry': 'Tour agency registry',
    'footer.company': 'Company details',
    'footer.copyright': 'Copyright',
    'footer.copyban': 'Copying materials is prohibited',

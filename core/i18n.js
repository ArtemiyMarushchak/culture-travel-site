...
export const STRINGS = {
  ru: {
    ...
    'error.text': 'Возможно, адрес был изменён или страница временно недоступна. Вернитесь на главную страницу или свяжитесь со мной, чтобы продолжить планирование путешествия.',
  ...
  en: {
    ...
    'error.text': 'The address may have changed, or the page is temporarily unavailable. Return to the home page or get in touch to keep planning your journey.',
